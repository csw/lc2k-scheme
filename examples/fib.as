...
I102    sw      7       6       5       ; store spilled value return-addr
        beq     0       1       I103   
        lw      0       5       C12     ; -1   
        add     1       5       6       (temp 1) = (local n) + (constant -1 -1)
        add     2       3       1       (temp 2) = (local a) + (local b)
        sw      7       1       4       ; store arg value #f
        add     0       6       1       ; marshal arg 1
        add     0       3       2       ; marshal arg 2
        lw      7       3       4       ; load arg value (temp 2)
        lw      7       6       5       ; load spilled value return-addr
        beq     0       0       I102    ; tail-call (<self> (temp 1) (local b) (temp 2))
...
L17     lw      0       4       C3     
        ...
        jalr    4       5       ; tail-call (fib-aux (local n) (constant 0 0) (constant 1 1))
...
L18     lw      0       4       C3     
        ...
        jalr    4       5       ; tail-call (fib (constant 21 21))
stack   .fill 65535
heapS   .fill 8192
heap    .fill 8192
