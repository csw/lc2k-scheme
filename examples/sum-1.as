...
L16     lw      0       4       C2     
        add     7       4       7       ; SP -= 5
I104    sw      7       6       5       ; store spilled value relocated
        lw      0       3       C8      ; (temp 1) = ()
        beq     1       3       I105   
        ...
        jalr    5       6       ; call cdr
        add     0       1       3       ; store result
        lw      7       1       4       ; load restored value (local l)
        ...
        lw      7       2       3       ; load restored value (local acc)
        lw      7       3       2       ; load restored value (temp 2)
        add     6       2       1      
...
I105    lw      7       5       5       ; load spilled value return-addr
        add     0       2       1       ; place return value
        lw      0       4       C3     
        add     7       4       7       ; SP += 5
        jalr    5       4       ; return
...
L17     lw      0       4       C16    
        add     7       4       7       ; SP -= 8
        sw      7       6       8       ; store spilled value relocated
        lw      0       5       C5      ; (temp 1) = 1
        sw      7       5       3       ; store spilled value (temp 1)
        lw      0       5       C12     ; (temp 2) = 2
        sw      7       5       2       ; store spilled value (temp 2)
        lw      0       5       C13     ; (temp 3) = 3
        sw      7       5       1       ; store spilled value (temp 3)
        lw      0       6       C14     ; (temp 4) = 4
        lw      0       1       C3      ; (temp 5) = 5
        lw      0       2       C8      ; (temp 6) = empty
        sw      7       6       4       ; store saved value (temp 4)
        lw      0       5       Acons   ; load address of cons
        jalr    5       6       ; call cons
        add     0       1       3       ; store result
        lw      7       6       4       ; load restored value (temp 4)
        add     0       6       1       ; marshal arg 1
        add     0       3       2       ; marshal arg 2
        lw      0       5       Acons   ; load address of cons
        jalr    5       6       ; call cons
        add     0       1       2       ; store result
        lw      7       1       1       ; load arg value (temp 3)
        lw      0       5       Acons   ; load address of cons
        jalr    5       6       ; call cons
        add     0       1       3       ; store result
        ...
        jalr    5       6       ; call cons
        add     0       1       2       ; store result
        lw      7       1       3       ; load arg value (temp 1)
        lw      0       5       Acons   ; load address of cons
        jalr    5       6       ; call cons
        add     0       1       3       ; store result
        lw      0       2       C15     ; (temp 12) = 0
        add     0       3       1       ; marshal arg 1
        lw      7       6       8       ; load spilled value return-addr
        lw      0       4       C17    
        add     7       4       7       ; SP += 8
        lw      0       4       A16     ; load target address
        jalr    4       5       ; tail-call sum
stack   .fill 65535
heapS   .fill 8192
heap    .fill 8192
